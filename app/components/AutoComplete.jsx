...
function AutoComplete({captionList, filterOptions, setInputValue, setFilterValue, selectedAccount, searchTerm }) {
  ...
  const [selected, setSelected] = useState(filterOptions ? filterOptions[0].value : "all");
